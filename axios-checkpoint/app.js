...
const tunis = axios.get(
    `http://api.openweathermap.org/data/2.5/weather?q=tunis&appid=${process.env.API_KEY}`
);
const france = axios.get(
    `http://api.openweathermap.org/data/2.5/weather?q=france&appid=${process.env.API_KEY}`
);
